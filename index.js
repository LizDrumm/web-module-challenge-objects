...
console.log (createMenuItem("Sushi", 15, "Dinner"));
console.log (createMenuItem ("Gumbo" , 10, "Dinner"));
...
console.log (addReview (reviews, 'Robert', 5, 'Awesome atmosphere and authentic cuisine.' ));
...
*/
//dont need to loop because its given the index
